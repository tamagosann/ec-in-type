...
export const UsersReducer = (state = initialState.users, action:
    ...
    | ReturnType<typeof Actions.fetchProductsInCartAction>
    | ReturnType<typeof Actions.fetchOrderHistoryAction>
    | ReturnType<typeof Actions.addToCartAction>
    | ReturnType<typeof Actions.removeFromCartAction>
    | ReturnType<typeof Actions.logOutUserAction>
    ) => {
    switch (action.type) {
