...
export type ClosableDrawerProps = {
    open: boolean
    isSignedIn: boolean
    onClose: (event: React.MouseEvent<HTMLButtonElement, globalThis.MouseEvent>) => void
}
...
const ClosableDrawer: FC<ClosableDrawerProps> = (props) => {
    ...
    return (
        <Drawer
            ...
            anchor="right"
            open={props.open}
            onClose={(e: React.MouseEvent<HTMLButtonElement, globalThis.MouseEvent>) => props.onClose(e)}
